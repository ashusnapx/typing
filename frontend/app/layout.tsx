        ...
        <footer className='border-t-2 border-pencil bg-white mt-auto'>
          ...
          <div className='max-w-5xl mx-auto px-6 py-10'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8'>
              ...
              <div className='sm:col-span-2 md:col-span-1'>
                ...
                >
                  ...
                  <div>
                    ...
                    <span className='block text-xs font-hand text-pencil/50 font-normal'>
                      {APP.tagline}
                    </span>
                  </div>
                </Link>
              ...
              {/* Exam Links */}
              <div>
                <h3 className='text-base font-bold text-pencil font-marker mb-3'>
                  Exam Modes
                </h3>
              ...
              <div>
                ...
                <div className='flex space-x-3'>
                  {FOOTER.socialLinks.map((link) => {
                    const Icon =
                      { Youtube, Instagram, Send, Github }[link.icon] ||
                      ExternalLink;
                    return (
                      <a
                        key={link.label}
          ...
          <div className='border-t-2 border-pencil/20 py-4'>
            <div className='max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-2'>
              <div className='text-center sm:text-left'>
                <p className='text-sm font-hand text-pencil/60'>
                  {FOOTER.legal.copyright}
                </p>
                <p className='text-xs font-hand text-pencil/40'>
